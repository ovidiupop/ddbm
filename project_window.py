...
from project_window_utils import setup_window, show_info_message, on_cancel, on_escape, adjust_window_size
...
class ProjectWindow:
    def __init__(self, parent, project_name, refresh_callback=None, available_dbs=None):
        ...
        print(f"Available DBs: {self.available_dbs}")  # Adaugă această linie
